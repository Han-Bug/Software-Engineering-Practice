...
bool post_detailed_info::updateInfo()
{
    ...
    bool num1,num2;
    num1 = db.Fabulous_UserToPost(ap->postId,Data::personalInfo->name);
    num2 = db.Collect_UserToPost(ap->postId,Data::personalInfo->name);
...
void post_detailed_info::on_pushButton_thumb_clicked()//点赞
{
    ...
    db.insertData_Fabulous_UserToPost(ap->postId,Data::personalInfo->name);
}
...
void post_detailed_info::on_pushButton_collect_clicked()//收藏
{
    ...
    db.insertData_Collect_UserToPost(ap->postId,Data::personalInfo->name);
}
...
void post_detailed_info::on_pushButton_Delthumb_clicked()//取消点赞
{
    ...
    db.deleteData_Fabulous_UserToPost(ap->postId,Data::personalInfo->name);
}
...
void post_detailed_info::on_pushButton_Delcollect_clicked()//取消收藏
{
    ...
    db.deleteData_Collect_UserToPost(ap->postId,Data::personalInfo->name);
}
